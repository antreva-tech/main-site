      ...
      <div className="mt-2 flex flex-col gap-2">
        <div>
          ...
          <input
            ...
            className="w-full text-sm text-gray-600 file:mr-3 file:py-1.5 file:px-3 file:rounded-lg file:border-0 file:bg-[#1C6ED5]/10 file:text-[#1C6ED5] file:font-medium"
          />
