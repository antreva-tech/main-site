...
export function AssignTicketModal({
  ...
  return (
    ...
    >
      ...
      >
        <h2 id="assign-ticket-title" className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">
          Assign ticket
        </h2>
        <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
          This ticket has no assignee. Please assign it to someone before changing the status.
        </p>
        <label htmlFor="assign-select" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
          Assign to
        </label>
        <select
          id="assign-select"
          ...
          disabled={isPending}
          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-[#1C6ED5] disabled:opacity-50 text-sm mb-6"
        >
